...
class Transaction {
  ...
  final Member? member; // Keep Member type for internal use in Flutter
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) {
    ...
    if (json['memberId'] != null) {
      parsedMember = Member(
        ...
        person: person,
        // balance: json['memberBalance']?.toDouble(),
      );
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    // Send member data in the structure expected by backend
