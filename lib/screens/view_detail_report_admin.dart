...
class ViewDetailReportScreen extends StatelessWidget {
  final Report report;
  final bool
  isEnglish; // ตัวแปรสำหรับเลือกภาษา (ควรเปลี่ยนเป็นระบบ Localization ในอนาคต)
        ...
        child: Column(
          ...
          children: [
            ...
            CircleAvatar(
              ...
              // IMPROVED: Use a more robust check for network vs asset image
              backgroundImage:
              ...
              onBackgroundImageError: (exception, stackTrace) {
                ...
                // Optionally, you could use setState here to force a fallback to AssetImage
              },
            ),
